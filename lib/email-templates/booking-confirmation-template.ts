...
export const getBookingConfirmationTemplate = (data: BookingConfirmationEmailData): string => {
  ...
  const content = `
    ...
    <p>Thank you for choosing Centourism! Your booking has been confirmed.</p>
    ...
    <p style="margin-top: 30px;">
      If you have any questions, feel free to contact us at <a href="mailto:sales@centourism.com">sales@centourism.com</a>
    </p>
