...
export const getContactFormTemplate = (data: ContactFormEmailData): string => {
  ...
  const content = `
    ...
    <p>You have received a new message from the contact form on ${companyName}</p>
    ...
    <a href="mailto:${email}?subject=Re: Your inquiry on ${companyName}" class="button">Reply to Customer</a>
